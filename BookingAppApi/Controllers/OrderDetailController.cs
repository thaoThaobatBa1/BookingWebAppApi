...
public class OrderDetailController : ControllerBase
{
    ...
    public async Task<IActionResult> AddOrderDetail([FromBody] OrderDetailModel orderDetailMD)
    {
        ...
        var exitOderDetail = _context.OrderDetails.FirstOrDefault(a => a.MenuItemID == orderDetailMD.MenuItemID && a.MenuItemID == orderDetailMD.MenuItemID);
        if (exitOderDetail != null)
        {
            exitOderDetail.Quantity = exitOderDetail.Quantity + orderDetailMD.Quantity;
            exitOderDetail.Price = (exitOderDetail.Quantity + orderDetailMD.Quantity) * _context.MenuItems.FirstOrDefault(a => a.MenuItemID == orderDetailMD.MenuItemID).Price;
